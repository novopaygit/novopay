...
$sql = " select b.mall_nm, DATE_FORMAT(a.pay_dt, '%Y-%m-%d') paydate,DATE_FORMAT(a.pay_dt, '%H:%i:%s') paytime
		,a.price krw_amt,a.currency,a.amount currency_amt,a.status,a.buyer_name,a.item_name,a.order_id
...
// Put Excel data
$data = array('쇼핑몰','결제일','결제시간','결제금액','결제화폐','화폐금액','거래상태','구매자명','상품명','쇼핑몰주문번호','취소여부','취소일시','노보페이결제번호','송금주소');
